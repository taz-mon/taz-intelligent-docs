...
<Card kind="tile" title="FinOps for Engineers" href="/docs/case-studies" icon="fa-duotone fa-folder-open">Browse real-world projects and measurable outcomes from my work</Card>
  <Card kind="tile" title="Examples" href="/docs/case-studies" icon="fa-duotone fa-folder-open">Browse real-world projects and measurable outcomes from my work</Card>
